            ...
            <div className="shrink-0">
              {barbershop.logo_url ? (
                <img
                  ...
                  alt={barbershop.name}
                  className="w-32 h-32 md:w-40 md:h-40 rounded-2xl object-cover shadow-xl border-4 border-background"
                />
              ) : (
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-2xl bg-primary flex items-center justify-center shadow-xl">
